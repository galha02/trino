...
public class TestMultimapAggAggregation
{
    ...
    public void testMultiplePages()
    {
        ...
        GroupedAggregator groupedAggregator = aggFunction.createSingleAggregatorFactory(ImmutableList.of(0, 1), OptionalInt.empty()).createGroupedAggregator();
    ...
    public void testEmptyStateOutputIsNull()
    {
        ...
        GroupedAggregator groupedAggregator = aggregationFunction.createSingleAggregatorFactory(Ints.asList(), OptionalInt.empty()).createGroupedAggregator();
