        ...
        extends BasePlanTest
{
    ...
    public void testBetween()
    {
        ...
        testUnwrap("bigint", "a BETWEEN DOUBLE '1.1' AND DOUBLE '2.2'", "a BETWEEN BIGINT '2' AND BIGINT '2'");
        // non-representable, min cast round up, max cast round down
        testUnwrap("bigint", "a BETWEEN DOUBLE '1.1' AND DOUBLE '1.1'", "(a IS NULL) AND CAST(NULL AS BOOLEAN)");
        // non-representable, min cast round up, max cast round down
        testUnwrap("bigint", "a BETWEEN DOUBLE '1.1' AND DOUBLE '1.9'", "(a IS NULL) AND CAST(NULL AS BOOLEAN)");
        // non-representable, min cast round up, max cast round down
        testUnwrap("bigint", "a BETWEEN DOUBLE '1.9' AND DOUBLE '1.9'", "(a IS NULL) AND CAST(NULL AS BOOLEAN)");
        // non-representable, min cast round down, max cast no rounding
        testUnwrap("bigint", "a BETWEEN DOUBLE '1.1' AND DOUBLE '2'", "a BETWEEN BIGINT '2' AND BIGINT '2'");
        // non-representable, min cast round up, max cast round down
        ...
        testUnwrap("bigint", "a BETWEEN DOUBLE '1.9' AND DOUBLE '2.9'", "a BETWEEN BIGINT '2' AND BIGINT '2'");
        ...
        testUnwrap("bigint", "a BETWEEN DOUBLE '2' AND DOUBLE '2.9'", "a BETWEEN BIGINT '2' AND BIGINT '2'");
        ...
        // illegal range
        testUnwrap("smallint", "a BETWEEN DOUBLE '5' AND DOUBLE '4'", "(a IS NULL) AND CAST(NULL AS BOOLEAN)");

        // NULL
        testUnwrap("smallint", "a BETWEEN NULL AND DOUBLE '2'", "CAST(null AS boolean) AND (a <= SMALLINT '2')");
        testUnwrap("smallint", "a BETWEEN DOUBLE '2' AND NULL", "(a >= SMALLINT '2') AND CAST(null AS boolean)");

        // nan
        testUnwrap("smallint", "a BETWEEN nan() AND DOUBLE '2'", "(a IS NULL) AND CAST(NULL AS BOOLEAN) AND (a <= SMALLINT '2')");
        testUnwrap("smallint", "a BETWEEN DOUBLE '2' AND nan()", "(a >= SMALLINT '2') AND (a IS NULL) AND CAST(NULL AS BOOLEAN)");

        // min and max below bottom of range
        testUnwrap("smallint", "a BETWEEN DOUBLE '-50000' AND DOUBLE '-40000'", "(a IS NULL) AND CAST(NULL AS BOOLEAN)");
        ...
        testUnwrap("smallint", "a BETWEEN DOUBLE '-32767.9' AND DOUBLE '0'", "a BETWEEN SMALLINT '-32767' AND SMALLINT '0'");
        ...
        testUnwrap("smallint", "a BETWEEN DOUBLE '32765.9' AND DOUBLE '32766.9'", "a BETWEEN SMALLINT '32766' AND SMALLINT '32766'");
        ...
        testUnwrap("smallint", "a BETWEEN DOUBLE '40000' AND DOUBLE '50000'", "a IS NULL AND CAST(NULL AS BOOLEAN)");
        // min below range and max at the top of range
        testUnwrap("smallint", "a BETWEEN DOUBLE '-40000' AND DOUBLE '32767'", "NOT (a IS NULL) OR CAST(NULL AS BOOLEAN)");
        // min below range and max above range
        testUnwrap("smallint", "a BETWEEN DOUBLE '-40000' AND DOUBLE '40000'", "NOT (a IS NULL) OR CAST(NULL AS BOOLEAN)");
    ...
    public void testUnwrapCastTimestampAsDate()
    {
        ...
        testUnwrap("timestamp(9)", "CAST(a AS DATE) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a >= TIMESTAMP '1981-06-22 00:00:00.000000000' AND a < TIMESTAMP '1981-07-24 00:00:00.000000000'");
        testUnwrap("timestamp(12)", "CAST(a AS DATE) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a >= TIMESTAMP '1981-06-22 00:00:00.000000000000' AND a < TIMESTAMP '1981-07-24 00:00:00.000000000000'");
    ...
    public void testUnwrapConvertTimestampToDate()
    {
        ...
        // between
        testUnwrap("timestamp(0)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a BETWEEN TIMESTAMP '1981-06-22 00:00:00' AND TIMESTAMP '1981-07-23 23:59:59'");
        testUnwrap("timestamp(1)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a BETWEEN TIMESTAMP '1981-06-22 00:00:00.0' AND TIMESTAMP '1981-07-23 23:59:59.9'");
        testUnwrap("timestamp(2)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a BETWEEN TIMESTAMP '1981-06-22 00:00:00.00' AND TIMESTAMP '1981-07-23 23:59:59.99'");
        ...
        testUnwrap("timestamp(4)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a BETWEEN TIMESTAMP '1981-06-22 00:00:00.0000' AND TIMESTAMP '1981-07-23 23:59:59.9999'");
        testUnwrap("timestamp(5)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a BETWEEN TIMESTAMP '1981-06-22 00:00:00.00000' AND TIMESTAMP '1981-07-23 23:59:59.99999'");
        ...
        testUnwrap("timestamp(7)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a >= TIMESTAMP '1981-06-22 00:00:00.0000000' AND a < TIMESTAMP '1981-07-24 00:00:00.0000000'");
        testUnwrap("timestamp(8)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a >= TIMESTAMP '1981-06-22 00:00:00.00000000' AND a < TIMESTAMP '1981-07-24 00:00:00.00000000'");
        testUnwrap("timestamp(9)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a >= TIMESTAMP '1981-06-22 00:00:00.000000000' AND a < TIMESTAMP '1981-07-24 00:00:00.000000000'");
        testUnwrap("timestamp(10)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a >= TIMESTAMP '1981-06-22 00:00:00.0000000000' AND a < TIMESTAMP '1981-07-24 00:00:00.0000000000'");
        testUnwrap("timestamp(11)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a >= TIMESTAMP '1981-06-22 00:00:00.00000000000' AND a < TIMESTAMP '1981-07-24 00:00:00.00000000000'");
        testUnwrap("timestamp(12)", "date(a) BETWEEN DATE '1981-06-22' AND DATE '1981-07-23'", "a >= TIMESTAMP '1981-06-22 00:00:00.000000000000' AND a < TIMESTAMP '1981-07-24 00:00:00.000000000000'");
