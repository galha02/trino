...
public class TestInlineFunctions
{
    ...
    public void testLanguageEngineFunctionProperties()
    {
        assertThat(assertions.query(
                ...
                .hasMessage("line 4:29: Function language TESTING property 'oops' does not exist");
        ...
        assertThat(assertions.query(
                ...
                .failure()
                .hasErrorCode(INVALID_FUNCTION_PROPERTY)
                .hasMessage("line 4:11: Invalid value for Function language TESTING property 'handler': Cannot convert [888] to varchar");
    }
    ...
    public void testLanguageEngineFunctionValidation()
    {
        assertThat(assertions.query(
                ...
                .hasMessage("line 1:6: Validation failed. Invalid return type: varchar");
        ...
        assertThat(assertions.query(
                ...
                .failure()
                .hasErrorCode(NOT_SUPPORTED)
                .hasMessage("line 1:6: Validation failed. Invalid argument types: [varchar]");
        ...
        assertThat(assertions.query(
                ...
                .failure()
                .hasErrorCode(INVALID_FUNCTION_PROPERTY)
                .hasMessage("line 1:6: Validation failed. Handler is required.");
        ...
        assertThat(assertions.query(
                ...
                .failure()
                .hasErrorCode(INVALID_FUNCTION_PROPERTY)
                .hasMessage("line 1:6: Validation failed. Invalid handler value: abc");
        ...
        assertThat(assertions.query(
                ...
                .hasMessage("line 1:6: Validation failed. Invalid definition: oops");
    }
            ...
            implements LanguageFunctionEngine
    {
        ...
        public void validateScalarFunction(Type returnType, List<Type> argumentTypes, String definition, Map<String, Object> properties)
        {
            if (!returnType.equals(BIGINT)) {
                throw new TrinoException(NOT_SUPPORTED, "Validation failed. Invalid return type: " + returnType);
            }

            if (!argumentTypes.equals(List.of(BIGINT))) {
                throw new TrinoException(NOT_SUPPORTED, "Validation failed. Invalid argument types: " + argumentTypes);
            }

            String handler = (String) properties.get("handler");
            if (handler.isEmpty()) {
                throw new TrinoException(INVALID_FUNCTION_PROPERTY, "Validation failed. Handler is required.");
            }
            if (!handler.equals("correct")) {
                throw new TrinoException(INVALID_FUNCTION_PROPERTY, "Validation failed. Invalid handler value: " + handler);
            }

            if (!definition.strip().equals("magic")) {
                throw new TrinoException(FUNCTION_IMPLEMENTATION_ERROR, "Validation failed. Invalid definition: " + definition.strip());
            }
        }
