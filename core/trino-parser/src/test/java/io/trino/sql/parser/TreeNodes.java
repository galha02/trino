...
class TreeNodes
{
    ...
    {
        return new ColumnDefinition(location, identifier(location, name), type, true, false, emptyList(), Optional.empty());
    }

    public static ColumnDefinition columnDefinition(NodeLocation location, String name, DataType type, boolean nullable)
    {
        return new ColumnDefinition(location, identifier(location, name), type, nullable, false, emptyList(), Optional.empty());
    }
    ...
    {
        return new ColumnDefinition(location, identifier(location, name), type, nullable, false, emptyList(), Optional.of(comment));
    }
    ...
    {
        return new ColumnDefinition(location, identifier(location, name), type, nullable, false, properties, Optional.empty());
    }
