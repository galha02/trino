        ...
        implements ConnectorMergeSink
{
    ...
    private static ConnectorPageSink createUpdateSink(
            ...
            QueryBuilder queryBuilder)
    {
        List<JdbcColumnHandle> columns = jdbcClient.getColumns(session, relation.getSchemaTableName(), relation.getRemoteTableName());
    ...
    public void storeMergedRows(Page page)
    {
        ...
        if (updatePositionCount > 0) {
            ...
            System.arraycopy(extractRowIdBlocks(rowIdFields, updatePositionCount, updatePositions), 0, updateBlocks, updateAssignmentChannels.length, rowIdFields.size());
