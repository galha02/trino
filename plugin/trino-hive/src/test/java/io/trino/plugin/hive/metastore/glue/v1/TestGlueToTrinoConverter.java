...
import static io.trino.plugin.hive.metastore.glue.v1.GlueToTrinoConverter.getPartitionParameters;
...
public class TestGlueToTrinoConverter
{
    ...
    public void testConvertTableWithOpenCSVSerDe()
    {
        ...
        io.trino.metastore.Table trinoTable = GlueToTrinoConverter.convertTable(glueTable, testDatabase.getName());
    ...
    public void testConvertTableWithoutTableType()
    {
        ...
        io.trino.metastore.Table trinoTable = GlueToTrinoConverter.convertTable(table, testDatabase.getName());
