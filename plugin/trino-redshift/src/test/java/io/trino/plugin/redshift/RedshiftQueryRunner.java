...
public final class RedshiftQueryRunner
{
    ...
    public static final String UNLOAD_AWS_ACCESS_KEY = requiredNonEmptySystemProperty("test.redshift.unload.s3.access-key");
    public static final String UNLOAD_AWS_SECRET_KEY = requiredNonEmptySystemProperty("test.redshift.unload.s3.secret-key");
